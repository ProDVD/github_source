...
<head lang="en">
    ...
    <meta name="viewport" content="width=1366px,scale=0.4, user-scalable=yes">
        ...
        <script defer src="js/IndexDoc.js"></script>
        <? break; case 1 : ?>
  <link rel="stylesheet" href="css/userDoc.css">
  <script defer src="js/IndexForIOSDoc.js"></script>
<? break; case 2 : ?>
...
<body>
  ...
  <input type="date" class="form-control" id="basic-url" aria-describedby="basic-addon3">
        ...
        <div class="contentPanel">
            ...
            <? if($_GET['ssid']=='')
{	
	getSessionByDocEmail($_COOKIE['email'], $_POST['name'], $_POST['email'], $_POST['date_start'], $_POST['date_end']);
}
	  ?>
                <div class="scrollbar">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button class="btn btn-info fullPhoto " onclick="fullscreenPhotoFun()">
                        <span class="fa fa-arrows-alt"></span> Full screen</button>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="modalButCont">
                        <div class="buttonModal">
                            ...
                            <button class="btn btn-info playPauseVideo" onclick="playPauseFunction()">
                                <span class="fa fa-pause-circle" id="10000"></span> Play/Pause</button>
                            <button class="btn btn-info" onclick="goBack(-10)">
                                <span class="fa fa-undo"></span> Back</button>
