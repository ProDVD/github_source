...
getSessionsForUser($_COOKIE['uniqueID']);
?>
    <!DOCTYPE html>
    <html lang="en">
                ...
                <div class="modal-content" >
                    <div class="modal-header">
                        <a href="#" id="mylinkImg" class="btn btn-info">
                            ...
                            <button class="btn btn-info fullPhoto " onclick="fullscreenPhotoFun()"><span class="fa fa-arrows-alt"></span>  Full screen</button>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                     ...
                     <div class="modal-header">
                          <div class="modalButCont">
                            <div class="buttonModal">
                                ...
                                <span class="fa fa-download"></span>  Download</a>
                                <button class="btn btn-info fullscreenVideo" onclick="fullscreen()"><span class="fa fa-arrows-alt"></span>  Full Screen</button>
                                <button class="btn btn-info playPauseVideo" onclick="playPauseFunction()"><span class="fa fa-pause-circle" id="10000"></span>  Play/Pause</button>
                                <button class="btn btn-info" onclick="goBack(-10)"><span class="fa fa-undo"></span>  Back</button>
                                <button class="btn btn-info" onclick="goBack(10)">Forward  <span class="fa fa-repeat"></span></button>
                            </div>
